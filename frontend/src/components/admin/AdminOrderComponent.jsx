      ...
      <table className='table-auto w-full text-center border border-solid border-[#ccc] mt-[10px] rounded'>
        <thead className='border-bottom-[#ccc]'>
          <tr className='bg-blue-500 text-white'>
            ...
            <th className='w-[10%] p-[10px] text-[18px] uppercase'>Người đặt</th>
            <th className='w-[10%] p-[10px] text-[18px] uppercase'>Tổng tiền</th>
            <th className='w-[10%] p-[10px] text-[18px] uppercase'>Hình thức thanh toán</th>
            <th className='w-[10%] p-[10px] text-[18px] uppercase'>Trạng thái</th>
